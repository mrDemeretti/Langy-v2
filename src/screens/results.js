        ...
        <div class="screen screen--no-pad">
            ...
            <div class="results__content">
                ...
                <div class="card">
                    ...
                    ${activeTb ? `<div style="font-size:var(--fs-xs); color:var(--text-tertiary); margin-top:var(--sp-1); display:flex; align-items:center; gap:4px;">${LangyIcons.book} ${activeTb.title}</div>` : ''}
                </div>

                <!-- Average Score -->
                <div class="card" style="display:flex; align-items:center; gap:var(--sp-4);">
                    <div style="font-size:36px;">${avgScore >= 80 ? LangyIcons.trophy : avgScore >= 60 ? LangyIcons.barChart : LangyIcons.award}</div>
                    <div>
